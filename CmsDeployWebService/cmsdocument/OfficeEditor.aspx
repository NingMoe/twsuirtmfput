<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OfficeEditor.aspx.vb" Inherits="cmsdocument_OfficeEditor" %> 
...
<head runat="server">
  ...
  try{
    ...
    webform.WebOffice.EditType=0;                           //EditType:编辑类型  方式一、方式二  <参考技术文档>
    ...
    webform.WebOffice.ShowToolBar=2;                        //设置是否显示整个控件工具栏，包括OFFICE的工具栏。0显示    
    //以下为自定义菜单↓
