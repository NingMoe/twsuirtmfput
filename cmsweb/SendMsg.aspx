	...
	<div class="content-box-content">
		<div class="tab-content default-tab" id="form">
                ...
                <div id="mobilelibPanel" style="border:1px solid #6E9FDE;width:380px; margin-bottom:5px; display:none;"></div>
                            ...
                            <div id="mobiletip" style="color:red;margin-left:7px;line-height:24px;height:24px;margin-top:0;margin-bottom:0;">共计号码：0 个</div> <div style="margin-top:0;margin-bottom:0;">
                            <input name="checkmobile" id="checkmobile" class="button" style="margin-bottom:3px;margin-left:5px;" onClick="clearErr()" type="button" title="过滤错误号码" value="过滤错号" /></div>
						</td>
					</tr>
                    
                    <tr>
                    <td height="25" width="10%" align="right">                     </td>
                    <td height="25" align="left" class="auto-style1"><div align="left" style="padding-bottom:4px;padding-top:4px;">
                        <input name="btnAdd" ID="btnAdd" onclick="sub();" class="button" type="button" value="  发送短信  " />
                        <input style="margin-left:10px;" class="button" name="btnReset" ID="btnReset" type="reset" value="  清除信息  " />
                    </div>
                    </td>
					</tr>
                </table>
