...
#End Region
    ...
    Private Sub btnConfirm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfirm.Click
        ...
        Try
            CTableColOption.Save(CmsPass, VLng("PAGE_RESID"), VStr("PAGE_COLNAME"), fldOpts)
    ...
    Private Sub LoadFieldOptions()
        ...
        Dim fldOpts As ArrayList = CTableColOption.Get(CmsPass, VLng("PAGE_RESID"), VStr("PAGE_COLNAME"))
