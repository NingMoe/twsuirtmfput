<%@ Page Language="vb" AutoEventWireup="false" Inherits="Unionsoft.Cms.Web.ResourceRelationList" CodeFile="ResourceRelationList.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<TITLE id="onetidTitle">管理表设置</TITLE>
							...
							<TR height="22">
								<td>
									<table cellSpacing="0" cellPadding="0" width="99%" border="0">
										...
										<TR height="22">
											<TD>
												<asp:button id="btnAdd" runat="server" Text="添加" Width="60px"></asp:button><asp:button id="btnEdit" runat="server" Text="修改" Width="60px"></asp:button><asp:button id="btnDelete" runat="server" Text="删除" Width="60px"></asp:button><asp:button id="btnExit" runat="server" Text="退出" Width="60px"></asp:button>&nbsp;
										...
										<TR>
											<TD><asp:LinkButton id="lbtnEnableRelEdit" runat="server">设置关联编辑</asp:LinkButton>&nbsp;<asp:LinkButton id="lbtnClearRelEdit" runat="server">清空关联编辑</asp:LinkButton>&nbsp;
												<asp:LinkButton id="lbtnSetToDocFlow" runat="server">设置工作流关联</asp:LinkButton>&nbsp;
												<asp:LinkButton id="lbtnClearDocFlow" runat="server">清空工作流关联</asp:LinkButton></TD>
										</TR>
									</table>
								</td>
							</TR>
