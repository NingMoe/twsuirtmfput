<%@ Page Language="vb" AutoEventWireup="false" Inherits="Unionsoft.Cms.Web.BatchSendEmailSetting" validateRequest="false" CodeFile="BatchSendEmailSetting.aspx.vb" %>
                ...
                <tr>
                    ...
                    <td>
                        <TABLE class="table_level2" cellSpacing="0" cellPadding="0" width="750" border="0">
                            <TR>
                                <TD colspan="2" class="header_level2" align="center" height="19"><asp:Label id="lblTitle" runat="server"></asp:Label></TD>
                            </TR>
                            <TR>
                                <TD vAlign="middle" align="right" width="230" height="19"><asp:Label id="Label5" runat="server">发送方电子邮件：</asp:Label></TD>
                                <TD vAlign="middle" align="left" height="19"><asp:TextBox id="txtSmtpDispUser" runat="server" Width="240px"></asp:TextBox>
                            ...
                            <TR>
                                ...
                                <TD vAlign="middle" align="left" height="19"><asp:TextBox id="txtSmtpPass" runat="server" Width="240px" TextMode="Password"></asp:TextBox></TD>
                            </TR>
                            <TR>
                            ...
                            <TR>
                                ...
                                <TD vAlign="middle" align="left" height="19">
                                    <asp:Button id="btnSave" runat="server" Width="96px" Text="保存"></asp:Button><asp:Button id="btnExit" runat="server" Width="76px" Text="退出"></asp:Button></TD>
                            </TR>
                        </TABLE>
                    </td>
                </tr>
