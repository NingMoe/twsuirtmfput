...
Namespace Unionsoft.Cms.Web
    ...
    Partial Class ResourceSelect_View
        Inherits CmsPage
...
#End Region
        ...
        Private Sub btnChooseRes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnChooseRes.Click
            Try
                ...
                Response.Write("<script>document.parentWindow.parent.GetResourceSelectID('" + lngSelResID.ToString + "');document.parentWindow.parent.closeWindow1();</script>")
