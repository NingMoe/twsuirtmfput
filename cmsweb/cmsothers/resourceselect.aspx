...
<%@ Page Language="vb" AutoEventWireup="false" Inherits="Unionsoft.Cms.Web.ResourceSelect" CodeFile="ResourceSelect.aspx.vb" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE cellSpacing="0" cellPadding="0" width="100%" height="100%" border="0">
				<tr>
					<td width="4"></td>
					<td valign="top">
						<TABLE cellSpacing="0" cellPadding="0" width="604" border="0" class="table_level2" style="WIDTH: 604px; HEIGHT: 558px">
							<TR>
								<TD height="22" class="header_level2" style="WIDTH: 457px"><b>资源选择</b></TD>
							</TR>
							<TR>
							...
							<TR height="23">
								<td style="WIDTH: 457px">
									<TABLE cellSpacing="0" cellPadding="0" width="592" border="0" style="WIDTH: 592px; HEIGHT: 480px">
										<TR>
										...
										<tr>
											<td valign="top" style="WIDTH: 295px"><asp:Panel id="panelDepTree" style="BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; OVERFLOW: auto; BORDER-LEFT: 1px solid; BORDER-BOTTOM: 1px solid"
													Width="284" Height="520" runat="server"><%WebTreeDepartment.LoadResTreeView(CmsPass, Request, Response, "/cmsweb/cmsothers/ResourceSelect.aspx", "_self")%></asp:Panel>
											</td>
											<td valign="top"><asp:Panel id="panelResTree" style="BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; OVERFLOW: auto; BORDER-LEFT: 1px solid; BORDER-BOTTOM: 1px solid"
													Width="284" Height="520" runat="server"><%WebTreeResource.LoadResTreeView(CmsPass, Request, Response, "/cmsweb/cmsothers/ResourceSelect.aspx", "_self", "/cmsweb/cmsothers/ResourceSelect.aspx", "_self", , , , True, False)%></asp:Panel>
											</td>
										</tr>
									</TABLE>
								</td>
