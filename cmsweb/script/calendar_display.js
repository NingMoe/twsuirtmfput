...
function calendar(id,initDate,width,format) {
	...
	var months = Array("一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月");
	var weekdays = Array("星期日","星期一","星期二","星期三","星期四","星期五","星期六");
//style	
	document.write("<style type='text/css'>")
	document.write(".Calendar_Day_Selected {font-size:9pt;cursor:hand;vertical-align:center;background:white;text-align:center;background-image:url(/cmsweb/images/label38x14.gif);}")
	document.write(".Calendar_Day_Today {font-size:9pt;cursor:hand;vertical-align:center;text-align:center;background-image:url(/cmsweb/images/label38x14_2.gif);background-repeat:no-repeat;}")
...
//下拉式时间选单	
	...
	document.write("<tr><td><input type='button' style='font-size:6.5pt;height:10px;width:11px;background-image:url(/cmsweb/images/arrow_up11x9.gif); background-repeat: no-repeat; background-position: center center;' onclick='" + id + ".setYear(1);this.blur();'></td></tr>")
	document.write("<tr><td></td></tr>")
	document.write("<tr><td><input type='button' style='font-size:6.5pt;height:10px;width:11px;background-image:url(/cmsweb/images/arrow_down11x9.gif); background-repeat: no-repeat; background-position: center center;' onclick='" + id + ".setYear(-1);this.blur();'></td></tr>")
	...
	document.write("<tr><td colspan=7 onclick='" + id + ".setDay(new Date());' style='font-size:9pt;cursor:hand;font-weight:bold;'><img height=14px src=/cmsweb/images/label38x14_2.gif>")
	document.write("<span id=spnToday>")
	document.write("&nbsp;&nbsp;今天：" + today.getFullYear() + "-" + (today.getMonth() + 1) + "-" + today.getDate())
