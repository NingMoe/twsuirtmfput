<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddorEditXJRJZ.aspx.cs" Inherits="Base_Finance_AddorEditXJRJZ" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function LoadPro1(ResID, RecID) {
            var SelectRecordData1 = {
                ...
                Condition:" and 归档='是'",
                HasLastOperation: true,
                QueryKeyField: "请款编号,申请人,采购金额合计,申请日期,请款事由",
                UserDefinedSql: "282994819609",
                Columns: "请款编号#请款编号,申请人#申请人,采购金额合计#采购金额合计,申请日期#申请日期,请款事由#请款事由",
...
<body>
    <form id="form1" runat="server">
        <div class="con" id="div<%=ResID %>FormTable" style="overflow: hidden; position: relative; height: 100%; border: none">
            ...
            <div title="现金日记账" class="easyui-panel" collapsible="true" style="overflow: hidden; padding:1px; margin: 0px;width:100%;">
                <div class="easyui-panel" border="true" style="border-bottom: none;width:100%;">
                    <table width="100%" border="0" class="table2" cellspacing="0" cellpadding="0" id="Table3">
                        <tr>
                            ...
                            <th style="width:13%;">凭证编号</th>
                            <td style="width:22%;">
                            <input id="<%=ResID %>_凭证编号" type="text" class="easyui-textbox"  style="width: 95%;" /></td>
                        </tr>
                        <tr>
                            <th>摘要</th>
                            <td colspan="3">
                                <input id="<%=ResID %>_摘要" type="text" class="easyui-textbox" style="width: 98%" /></td>
                        </tr>
                        <tr>
                            <th>收款</th>
                         ...
                         <tr>
                           ...
                           <th>报销编号</th>
                            <td><input id="<%=ResID %>_报销编号" type="text" class="easyui-textbox" editable="false" style="width: 95%;" />
                            </td>
                        </tr>
                        <tr>
                            <th>请款编号</th>
                            <td><input id="<%=ResID %>_请款编号" type="text" class="easyui-textbox"  editable="false" style="width: 95%;" /></td>
                            <th>销售</th>
