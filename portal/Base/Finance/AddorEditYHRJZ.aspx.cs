...
public partial class Base_Finance_AddorEditYHRJZ : UserPagebase
{
    public string ResID = "423335232345";//银行日记账
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request["BackType"] != null)
        {
            BackType = Request["BackType"].ToString();   
        }
    }
}