<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddorEditTGJL.aspx.cs" Inherits="Base_Office_AddorEditTGJL" %>
...
<body>
    <form id="form1" runat="server">
        <div class="con" id="div<%=ResID %>FormTable" style="overflow: hidden; position: relative; height: 100%; border: none">
            ...
            <div title="推广记录" class="easyui-panel" collapsible="false" style="overflow: hidden; padding: 3px; margin: 0px;width:100%;">
                <div class="easyui-panel" border="true" style="border-bottom: none;width:100%;">
                    <table width="100%" border="0" class="table2" cellspacing="0" cellpadding="0" id="Table3">
                        <tr>
                            ...
                            <td style="width: 20%">
                            <input id="<%=ResID %>_月份" type="text" class="easyui-textbox" style="width: 95%;" /></td>
                            <th style="width: 13%">网站UV</th>
                            <td style="width: 20%">
                            <input id="<%=ResID %>_网站UV" type="text" class="easyui-textbox" style="width: 95%;" /></td>
                        </tr>
                        <tr>
                             <th>百度消费</th>
                            <td>  <input id="<%=ResID %>_百度消费" type="text" class="easyui-textbox" style="width: 95%;" />
                            </td>
                            <th>360消费</th>
                            <td>
                                <input id="<%=ResID %>_360消费" style="width: 95%;" type="text" class="easyui-textbox" /></td>
                        </tr>
                        <tr>
                            <th>搜狗消费</th>
                            <td><input id="<%=ResID %>_搜狗消费" type="text" class="easyui-textbox"  style="width: 95%;" /></td>                           
                            <th>商桥咨询量</th>
                            <td><input id="<%=ResID %>_商桥咨询量" type="text" class="easyui-textbox"  style="width: 95%;"/></td>
                        </tr>
                    </table>
                </div>
            </div>
