<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Center.aspx.cs" Inherits="Organization_Center" %>
...
<body class="easyui-layout"  >
	...
	<div region="west" id="westModel_id" split="true"  style="width:200px;" href="../SystemRights/UserTree.aspx?IsLoadUser=0&FromUrl=../FormListShowChildrenList.aspx?key=<%=key %>&MenuResID=<%=MenuResID %>"></div>
