<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddOrEditXSCKSJWD.aspx.cs" Inherits="Base_Project_AddOrEditXSCKSJWD" %>
            ...
            <div title="项目信息" class="easyui-panel" collapsible="true" style="overflow: hidden; padding: 3px; margin: 0px;width:100%;">
                <div class="easyui-panel" border="true" style="border-bottom: none;width:100%;">
                    <table width="100%" border="0" class="table2" cellspacing="0" cellpadding="0" id="Table3">
                        <tr>
                            <th style="width: 130px;">参考文档名称</th>
                            <td style="width: 250px;">
                               <input id="<%=ResID %>_参考文档名称"  class="easyui-textbox" style="width: 95%;" />
                                </td>
                        </tr>
                        <tr>    
                            <th>上传人</th>
                            <td><input id="<%=ResID %>_上传人"  value="<%=UserName %>"   class="easyui-textbox" style="width: 95%;" /></td>
                        </tr>     
                         <tr>
                            <th>上传日期</th>
                            <td><input id="<%=ResID %>_上传日期" value="<%=Time %>"  class="easyui-datebox" style="width: 95%;" /></td>
                        </tr> 
                         <tr>
                            <th>说明</th>
                            <td><input id="<%=ResID %>_说明"  class="easyui-textbox" style="width: 95%;" /></td>
                        </tr>     
                    </table>
                </div>
            </div>
