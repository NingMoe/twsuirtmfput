...
public partial class Base_Project_AddorEditXMGYSGL : UserPagebase
{
    public string ResID = "543937781149";//项目供应商合同文档管理ID
    public string DocResID = "546514741803";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.UploadFile1.ResID = DocResID;
        this.UploadFile1.ParentRecID = RecID;
        this.UploadFile1.ParentResID = ResID;
