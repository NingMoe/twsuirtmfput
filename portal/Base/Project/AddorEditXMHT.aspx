<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddorEditXMHT.aspx.cs" Inherits="Base_Project_AddorEditXMHT" %>
                    ...
                    <table width="100%" border="0" class="table2" cellspacing="0" cellpadding="0" id="Table3">
                        <tr>
                            ...
                            <td style="width: 250px;">
                               <input id="<%=ResID %>_项目编号"  class="easyui-textbox" style="width: 95%;" />
                                </td>
                        </tr>
                        <tr>    
                            <th>合同金额</th>
                            <td><input id="<%=ResID %>_合同金额"  class="easyui-textbox" style="width: 95%;" /></td>
                        </tr>     
                         <tr>
                            <th>合同时间</th>
                         ...
                         <tr>
                            <th>备注</th>
                            <td><input id="<%=ResID %>_备注"  class="easyui-textbox" style="width: 95%;" /></td>
                        </tr>     
                    </table>
                </div>
            </div>
