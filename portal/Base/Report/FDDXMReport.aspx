<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FDDXMReport.aspx.cs" Inherits="Base_Report_FDDXMReport" %>
...
<body>
    ...
    function loadCenterGrid(GridHeight, keyWordValue) {
          $('#CenterGrid' + keyWordValue).datagrid({
                ...
                url: "../Common/CommonAjax_Request.aspx?typeValue=GetDataByFDDXM",
                columns:[[
    				    { title: '督导', field: '督导', width: 100, align: 'left' },
