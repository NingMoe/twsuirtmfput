<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FXSXMReport.aspx.cs" Inherits="Base_Report_FXSXMReport" %>
...
<body>
    ...
    function loadCenterGrid(GridHeight, keyWordValue) {
          $('#CenterGrid' + keyWordValue).datagrid({
                ...
                url: "../Common/CommonAjax_Request.aspx?typeValue=GetDataByFXSXM",
                columns:[[
