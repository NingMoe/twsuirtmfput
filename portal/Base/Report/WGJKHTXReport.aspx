<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WGJKHTXReport.aspx.cs" Inherits="Base_Report_WGJKHTXReport" %>
...
<body>
    ...
    function loadCenterGrid(GridHeight, keyWordValue) {
          $('#CenterGrid' + keyWordValue).datagrid({
                ...
                url: "../Common/CommonAjax_Request.aspx?typeValue=GetDataByWGJKHTX",
                columns:[[
    				    { title: '客户全称', field: '客户全称', width: 300, align: 'left' },
					    { title: '销售', field: '销售', width: 160, align: 'center' }
				    ]],         			
//              pagination: true,
                showFooter:true,
                rownumbers: true,
    ...
    function searchReportList() {
     ...
     <div class="easyui-panel" id="allSearch_panel<%=keyWordValue %>"
        ...
        <div id="search_panel<%=keyWordValue %>" class="easyui-panel" style="overflow: hidden;"
            border="false">
            <div class="con1">
                &nbsp;&nbsp;销售 :<input type="text"  class="box3" style="width: 150px;" id="Seaxs" />
