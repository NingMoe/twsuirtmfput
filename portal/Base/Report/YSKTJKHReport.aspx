<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YSKTJKHReport.aspx.cs" Inherits="Base_Report_YSKTJKHReport" %>
...
<body>
    ...
    function loadCenterGrid(GridHeight, keyWordValue) {
          $('#CenterGrid' + keyWordValue).datagrid({
                ...
                url: "../Common/CommonAjax_Request.aspx?typeValue=GetfDataByYSKTJKH",
                columns:[[
    				    { title: '客户名称', field: '客户名称', width: 200, align: 'left', rowspan: 2 },
