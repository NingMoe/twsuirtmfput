<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YSKTJXSReport.aspx.cs" Inherits="Base_Report_YSKTJXSReport" %>
...
<body>
    ...
    function loadCenterGrid(GridHeight, keyWordValue) {
          $('#CenterGrid' + keyWordValue).datagrid({
                ...
                url: "../Common/CommonAjax_Request.aspx?typeValue=GetfDataByYSKTJXS",
                columns:[[
    				    { title: '销售', field: '销售', width: 100, align: 'center', rowspan: 2 },
