<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddOrEditConsumer.aspx.cs" Inherits="Base_SolidWaste_AddOrEditConsumer" %>
...
<body>
    ...
    <div class="con" id="div<%=ResID %>FormTable" style="overflow: hidden; position: relative; height: 100%; border: none">
        ...
        <div title="客户信息" class="easyui-panel" collapsible="false" style="overflow: hidden; padding: 3px; margin: 0px;width:100%;">
                <div class="easyui-panel" border="true" style="border-bottom: none;width:100%;">
                    <table width="100%" border="0" class="table2" cellspacing="0" cellpadding="0" id="Table3">
                        <tr>
                            ...
                            <td colspan="3" style="width:660px"><input id="<%=ResID %>_单位名称" type="text" class="easyui-textbox" style="width: 97%;" /></td>
                        </tr>
                        <tr>
                            <th style="width: 130px">联系人</th>
                            <td style="width: 260px"><input id="<%=ResID %>_联系人" type="text" class="easyui-textbox" style="width: 95%;" /> </td>
                            <th style="width: 110px">联系方式</th>
                            <td style="width: 260px"><input id="<%=ResID %>_联系方式" type="text" class="easyui-numberbox" style="width: 92%;" /></td>
                        </tr>
                        <tr>
                            <th style="width: 130px">手机</th>
                            <td style="width: 260px"><input id="<%=ResID %>_手机" type="text" class="easyui-numberbox" style="width: 95%;" /></td>
                            <th style="width: 110px">销售代表</th>
                            <td style="width: 260px"><input id="<%=ResID %>_销售代表" type="text" class="easyui-textbox" style="width: 86%;" /> </td>
                        </tr>
                        <tr>
                            <th style="width: 130px">地址</th>
                            <td colspan="3" style="width:660px"><input id="<%=ResID %>_地址" type="text" class="easyui-textbox" style="width: 94%;" /></td>
                        </tr>
                    </table>
                </div>
            </div>
