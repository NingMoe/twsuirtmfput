<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddOrEditInventory.aspx.cs" Inherits="Base_SolidWaste_AddOrEditInventory" %>
...
<body>
    ...
    <div class="con" id="div<%=ResID %>FormTable" style="overflow: hidden; position: relative; height: 100%; border: none">
        ...
        <div title="库存信息" class="easyui-panel" collapsible="false" style="overflow: hidden; padding: 3px; margin: 0px;width:100%;">
                <div class="easyui-panel" border="true" style="border-bottom: none;width:100%;">
                    <table width="100%" border="0" class="table2" cellspacing="0" cellpadding="0" id="Table3">
                        ...
                        <tr>
                            ...
                            <th style="width: 13%">出库件数</th>
                            <td style="width: 20%"><input id="<%=ResID %>_出库件数" type="text" class="easyui-numberbox" style="width: 95%;" /></td>
                        </tr>
                        <tr>
                            <th style="width: 13%">库存件数</th>
                            <td style="width: 20%"><input id="<%=ResID %>_库存件数" type="text" class="easyui-numberbox" style="width: 95%;" /></td>
                        </tr>
                    </table>
                </div>
            </div>
