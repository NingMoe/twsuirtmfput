...
public partial class Base_SystemConfig_DataKeyAdd : UserPagebase
{
    public string ResID = "536862532389";//数据字典表资源ID
    ...
    public string ParentKey = "";//选中记录的ID  
    public string KeyCode = "";//选中的修改记录的编号
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            ParentKey = Request["ParentKey"].ToString();
        }
        if (Request["KeyCode"] != null)
        {
            KeyCode = Request["KeyCode"].ToString();
        }
    }
}