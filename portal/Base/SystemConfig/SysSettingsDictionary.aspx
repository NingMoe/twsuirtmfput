<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SysSettingsDictionary.aspx.cs" Inherits="SysSettingsDictionary" %>
...
<body class="easyui-layout"  >
	...
	<div region="west" id="westModel_id" split="true"  style="width:200px;" href="<%=strUrl %>"></div>
    <div region="center"  id="centerModel_id" style="overflow:hidden;">
        <iframe  id="view_frame" width="100%"  frameborder="0" scrolling="no" >
        </iframe>
    </div>
</body>
</html>
