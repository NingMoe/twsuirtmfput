...
#End Region
    ...
    Private Sub BindData()
        ...
        Dim strValue As String = "FlowName LIKE '%{0}%' OR MAINFIELDVALUE LIKE '%{0}%' OR CreateTime LIKE '%{0}%' "
        If Me.txtkeyvalue.Text.Trim() <> "" Then
            strCondition = String.Format(strValue, Me.txtkeyvalue.Text.Trim())
        End If
        Me.DataGrid1.DataSource = Worklist.GetStartWorklistItems(Me.CurrentUser.Code, strCondition)
