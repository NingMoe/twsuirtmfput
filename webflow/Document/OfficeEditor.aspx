<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OfficeEditor.aspx.vb" Inherits="Unionsoft.Workflow.Web.cmsdocument_OfficeEditor" %> 

<html>
<head runat="server">
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" /> 
    <title>上海三盟軟件-工作流</title>
    <style type="text/css">
        body
        { 
            margin: 0px;
  ...
  try{
    ...
    webform.WebOffice.ShowToolBar=<%=iif(lngIsCheckOut=3,2,0) %>;                        //设置是否显示整个控件工具栏，包括OFFICE的工具栏。0显示    
    //以下为自定义菜单↓
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
        <tr>
          <td bgcolor="menu" height="98%" valign="top">
            <div id="DivID">
                <object id="WebOffice" width="100%" height="100%" classid="clsid:23739A7E-5741-4D1C-88D5-D50B18F7C347" codebase="../control/iWebOffice2003.ocx#version=8,3,0,0" >
                </object>
            </div>
        ...
        <tr>
			<td align="center">
				<asp:Button id="btnUpdateFile" runat="server" Text="保存文件" style="display:none;"></asp:Button>&nbsp;&nbsp;&nbsp;
				<asp:TextBox ID="txtFileName" runat="server" style="display:none;"></asp:TextBox>
				<input type="button" id="btnSave" value="保存文件" class="ButtonCommon" onclick="SaveFile();" />
...
if('<%=IsEnabled %>'=='True')
{
    document.getElementById("btnSave").disabled='<%=IsEnabled %>';
    document.getElementById("btnSave").value=document.getElementById("<%=btnUpdateFile.ClientID %>").value;
}
if('<%=lngIsCheckOut %>'=='3')
{
