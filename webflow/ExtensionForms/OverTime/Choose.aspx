...
<script language="vb" runat="server">
 Public table As DataTable
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sql As String = "select a.* from (select ProjectCode,ProjectName from PM_ProjectInfo where CreateDate > '2011-12-31' union all select mid,ProjectName from dbo.PM_MRenewal where isnull(M_state,'')='维护中') a"
