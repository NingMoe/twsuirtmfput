...
Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load	
 ...
 Dim OvertimeNo As String = TimeId.CurrentMilliseconds(30).ToString
    Dim hst As New Hashtable 
	hst.Add("ID",ViewState("_Id")) 
        hst.Add("RESID", 425123204191)
	hst.Add("CRTTIME",DateTime.Now)
	hst.Add("OvertimeNo",Request.Form("OvertimeNo"))
	...
	hst.Add("Overtimetype",Request.Form("Overtimetype"))
	hst.Add("Overtime",Request.Form("Overtime"))
 ...
 hst.Add("Date", DateTime.Now.ToString("yyyy-MM-dd"))
    ...
    hst.Add("ProjectCode", Request.Form("ProjectCode")) '项目编号
        ...
        SDbStatement.InsertRow(hst, "HR_OverTime")
...
function sumNum()
{
    ...
    //开始日期 时 分
        ...
        //计算开始
        if(Form1.Overtime.value=="NaN")
        {
	        Form1.Overtime.value=0;
        }
...
function Validate()
{
    if(parseFloat(document.getElementById("Overtime").value)<=0)
    {
        alert("加班时间必须大于零");
...
<tr >
                ...
                <td width="69" class="F_center">加班人</td>
  ...
  <tr>
    <td height="33" class="F_center">加班日期</td>
...
分</td>
  ...
  <tr>
    ...
    <td align="left" valign="middle" colspan="4">　
      <input type="text" name="Overtime" id="Overtime"  style="width:50px" class="noborder"  mInput="true" FieldType="num" FieldTitle="加班时间" readonly/>
      小时(请务必打卡)</td>
  
<!-- 
    <td class="F_center">是否调休</td>
    <td colspan="2" align="center"><input name="Toneoff" id="Toneoff" type="checkbox" value="0">换取调休</td>
-->
  </tr>
  <tr>
    <td class="F_center">加班事由</td>
    <td colspan="4" align="left" valign="top">　
       <textarea name="Explain" class="noborder" id="Explain" style="width:90%; height:90px" mInput="true" FieldTitle="加班事由"></textarea>   </td>
  </tr>
</table> 
