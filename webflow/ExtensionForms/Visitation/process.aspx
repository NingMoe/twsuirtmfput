...
Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
	...
	ViewState.Item("_Id") = oWorklistItem.ActivityInstance.WorkflowInstance.RecordId
        hstFormValues = GetFormValues(oWorklistItem.ActivityInstance.WorkflowInstance.RecordID, "HR_Visitation")
...
<table width="700" border="0" align="center" cellspacing="0" class="Bold_box">
 <tr style="height: 30px;">
  ...
  <tr>
    ...
    <td width="95" class="F_center">外出人</td>
  ...
  <tr>
    ...
    <td align="left" valign="middle" colspan="4">&nbsp;<%=hstFormValues("Visittime")%>小时</td>
